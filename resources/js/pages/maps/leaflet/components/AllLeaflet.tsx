...
const LeafletQuickMap = () => {
    ...
    const multiPolyline: LatLngExpression[] | LatLngExpression[][] = [
        [
            [51.5, -0.1],
            [51.5, -0.12],
            [51.52, -0.12],
...
const VectorBoundMap = () => {
    const position: LatLngExpression = [39.69596043694606, -104.95084762573242];
    const polyline: LatLngExpression[] | LatLngExpression[][] = [
...
const TooltipMap = () => {
    const center: LatLngExpression = [51.505, -0.09];
    const multiPolygon: LatLngExpression[] | LatLngExpression[][] | LatLngExpression[][][] = [
        [
            [51.51, -0.12],
            [51.51, -0.13],
            [51.53, -0.13],
