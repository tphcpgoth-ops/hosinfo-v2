...
const IpdStatsSection = ({ stats, wards }: { stats: any, wards: any[] }) => {
                ...
                <Card className="border-0 shadow-sm overflow-hidden h-100" style={{ borderRadius: '0' }}>
                    <div className="bg-danger p-3 d-flex align-items-center gap-3">
                        ...
                        <div>
                            ...
                            <span className="text-white-50 small">จำนวนเตียงทั้งหมด {format(stats.ward_summary.bedcount)} เตียง</span>
                        </div>
                    </div>
                    <Card.Body className="p-0">
                        <ul className="list-group list-group-flush">
                            <li className="list-group-item d-flex justify-content-between align-items-center py-2 px-3">
                                ...
                                <span className="badge bg-danger rounded-pill">{format(stats.ipd_today.admittoday)} เตียง</span>
                            </li>
                            <li className="list-group-item d-flex justify-content-between align-items-center py-2 px-3">
                                <span>จำหน่ายวันนี้</span>
                                <span className="badge bg-warning rounded-pill text-dark">{format(stats.ipd_today.dchtoday)} เตียง</span>
                            </li>
                            <li className="list-group-item d-flex justify-content-between align-items-center py-2 px-3">
                                <span>Admit อยู่</span>
                                <span className="badge bg-primary rounded-pill">{format(stats.ward_summary.wtotal)} เตียง</span>
                            </li>
                            <li className="list-group-item d-flex justify-content-between align-items-center py-2 px-3">
                                <span>เตียงว่าง</span>
                                <span className="badge bg-success rounded-pill">{format(stats.ward_summary.wblank)} เตียง</span>
                            </li>
                            <li className="list-group-item d-flex justify-content-between align-items-center py-2 px-3">
