                        ...
                        <Card className="overflow-hidden text-center h-100 p-xxl-4 p-3 mb-0">
                            ...
                            <div className="d-flex align-items-center gap-2 mb-3 text-start">
                                ...
                                <div>
                                    ...
                                    <p className="mb-0">Thank you for using Osen Admin</p>
                                </div>
                            </div>
                            <div className="mb-3 text-start">
                                <div className="bg-success-subtle p-2 rounded fw-medium mb-0" role="alert">
                                    <p className="mb-0 text-success">
                                        You have been successfully logged out of your account. To continue using our services, please log in again
                                        with your credentials. If you encounter any issues, feel free to contact our support team for assistance.
                                    </p>
                                </div>
                            </div>
                            ...
                            <p className="text-danger fs-14 my-3">
                                Back to{' '}
                                <Link href={route('login')} className="text-dark fw-semibold ms-1">
                                    Login !
                                </Link>
                            </p>
